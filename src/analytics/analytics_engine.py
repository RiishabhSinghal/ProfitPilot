...
class AnalyticsEngine:
    ...
    def analyze(self, dataframe: pd.DataFrame) -> dict:
        ...
        report = {
            ...
            "product": self._product_analysis(dataframe),
            "region": self._region_analysis(dataframe),
            "time": self._time_analysis(dataframe),
    ...
    def _customer_analysis(
        ...
        """
        Perform customer-related business analysis.
        """

        self.logger.info("Running customer analysis...")

        report = {
        "revenue_by_customer": self._revenue_by_customer(dataframe),
        "profit_by_customer": self._profit_by_customer(dataframe),
        "top_customers_by_revenue": self._top_customers_by_revenue(dataframe),
        "top_customers_by_profit": self._top_customers_by_profit(dataframe),
        "customers_with_most_orders": self._customers_with_most_orders(dataframe),
        "average_spend_per_customer": self._average_spend_per_customer(dataframe),
        "customer_contribution": self._customer_contribution(dataframe),
        }

        self.logger.info("Customer analysis completed successfully.")
    ...
    def _profit_by_customer(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
        Calculate profit generated by each customer.
        """
    ...
    def _top_customers_by_profit(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
        Return the top customers ranked by profit.
        """
    ...
    def _customers_with_most_orders(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
        Return the customers who placed the most orders.
        """

        report = (
            dataframe.groupby(self.CUSTOMER_NAME_COLUMN)
            .size()
            .sort_values(ascending=False)
            .head(self.TOP_N)
            .to_dict()
    ...
    def _average_spend_per_customer(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
        ...
        return self._groupby_mean(
            dataframe,
            group_column=self.CUSTOMER_NAME_COLUMN,
            value_column=self.SALES_COLUMN,
        )

    def _customer_contribution(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
        ...
        revenue = (
            dataframe.groupby(self.CUSTOMER_NAME_COLUMN)[self.SALES_COLUMN]
            .sum()
        )
    ...
    def _product_analysis(
        ...
        """
        Perform product-related business analysis.
        """

        self.logger.info("Running product analysis...")

        report = {
            "revenue_by_product": self._revenue_by_product(dataframe),
            "profit_by_product": self._profit_by_product(dataframe),
            "top_products_by_revenue": self._top_products_by_revenue(dataframe),
            "top_products_by_profit": self._top_products_by_profit(dataframe),
            "product_contribution": self._product_contribution(dataframe),
        }
    ...
    def _top_products_by_profit(
        ...
        """
        Return the top products ranked by profit.
        """
    ...
    def _product_contribution(
        ...
        revenue = (
            dataframe.groupby(self.PRODUCT_NAME_COLUMN)[self.SALES_COLUMN]
            .sum()
        )
    ...
    def _region_analysis(
        ...
        """
        Perform region-related business analysis.
        """

        self.logger.info("Running region analysis...")

        report = {
            "revenue_by_region": self._revenue_by_region_analysis(dataframe),
            "profit_by_region": self._profit_by_region_analysis(dataframe),
            "orders_by_region": self._orders_by_region(dataframe),
            "customers_by_region": self._customers_by_region(dataframe),
            "profit_margin_by_region": self._profit_margin_by_region(dataframe),
            "region_contribution": self._region_contribution(dataframe),
        }

        self.logger.info("Region analysis completed successfully.")

        return report

    def _revenue_by_region_analysis(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
    ...
    def _profit_by_region_analysis(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
    ...
    def _orders_by_region(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
        Count orders placed in each region.
        """

        return (
            dataframe
            .groupby(self.REGION_COLUMN)[self.ORDER_COLUMN]
            .nunique()
            .sort_values(ascending=False)
            .to_dict()
        )

    def _customers_by_region(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
        ...
        return (
            dataframe.groupby(self.REGION_COLUMN)[self.CUSTOMER_ID_COLUMN]
            .nunique()
            .sort_values(ascending=False)
            .to_dict()
        )

    def _profit_margin_by_region(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
        ...
        regional_profit = (
            dataframe.groupby(self.REGION_COLUMN)[self.PROFIT_COLUMN]
            .sum()
        )

        regional_sales = (
            dataframe.groupby(self.REGION_COLUMN)[self.SALES_COLUMN]
            .sum()
        )

        profit_margin = (
            (regional_profit / regional_sales) * 100
        ).round(2)
    ...
    def _region_contribution(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
        Calculate percentage contribution of each region to overall revenue.
        """
    ...
    def _time_analysis(
        ...
        """
            Perform time-series business analysis.
        """

        self.logger.info("Running time analysis...")

        report = {
            "monthly_sales": self._monthly_sales(dataframe),
            "monthly_profit": self._monthly_profit(dataframe),
            "yearly_sales": self._yearly_sales(dataframe),
            "yearly_profit": self._yearly_profit(dataframe),
            "monthly_orders": self._monthly_orders(dataframe),
        }

        self.logger.info("Time analysis completed successfully.")
    ...
    def _prepare_datetime(
        ...
        dataframe[self.ORDER_DATE_COLUMN] = pd.to_datetime(
            dataframe[self.ORDER_DATE_COLUMN]
        )
    ...
    def _monthly_sales(
        ...
        dataframe = self._prepare_datetime(dataframe)

        report = (
            dataframe
            .groupby(
                dataframe[self.ORDER_DATE_COLUMN].dt.to_period("M")
            )[self.SALES_COLUMN]
            .sum()
            .round(2)
        )
    ...
    def _yearly_sales(
        ...
        return (
            dataframe
            .groupby(
                dataframe[self.ORDER_DATE_COLUMN].dt.year
            )[self.SALES_COLUMN]
            .sum()
            .round(2)
            .to_dict()
    ...
    def _discount_analysis(
        ...
        """
        Perform discount-related business analysis.
        """

        self.logger.info("Running discount analysis...")

        report = {
            "average_discount_by_category":
                self._average_discount_by_category(dataframe),

            "average_discount_by_subcategory":
                self._average_discount_by_subcategory(dataframe),

            "average_discount_by_region":
                self._average_discount_by_region(dataframe),

            "average_discount_by_segment":
                self._average_discount_by_segment(dataframe),

            "most_discounted_products":
                self._most_discounted_products(dataframe),

            "discount_vs_profit":
                self._discount_vs_profit(dataframe),
        }

        self.logger.info("Discount analysis completed successfully.")

        return report

    def _average_discount_by_category(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
        ...
        return self._groupby_mean(
            dataframe=dataframe,
            group_column=self.CATEGORY_COLUMN,
            value_column=self.DISCOUNT_COLUMN,
        )

    def _average_discount_by_subcategory(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
    ...
    def _average_discount_by_region(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
        Calculate average discount for each region.
        """
    ...
    def _average_discount_by_segment(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
    ...
    def _most_discounted_products(
        self,
        dataframe: pd.DataFrame,
        n: int = 10,
    ) -> dict:
        """
        Get the top N most discounted products.
        """

        report = (
            dataframe
            .groupby(self.PRODUCT_NAME_COLUMN)[self.DISCOUNT_COLUMN]
            .mean()
            .round(2)
            .sort_values(ascending=False)
            .head(n)
    ...
    def _discount_vs_profit(
        self,
        dataframe: pd.DataFrame,
    ) -> dict:
        """
        Compare product discounts with profitability.
        """

        correlation = dataframe[
            [self.DISCOUNT_COLUMN, self.PROFIT_COLUMN]
        ].corr().iloc[0, 1]
        ...
        return {
            ...
            "top_discounted_products": summary,
        }